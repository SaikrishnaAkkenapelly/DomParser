 ...
 *
 */
public class PojosToXml {
	public void XmlRetrieval(PoHeader poheader, Properties properties) {
		...
		final Logger logger = Logger.getLogger(PojosToXml.class);
		try {
			...
			StreamResult result = new StreamResult(new File("C:\\dev\\eclispeMarsWorkSpace\\SyncPOParser\\output.xml"));
